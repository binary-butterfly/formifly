...
describe.each([
    ...
    ['123', /[a-z]/, undefined, [false, 'regex'], 'returns false for non matching regexp'],
...
describe.each([
    ...
    ['abc', 4, undefined, [false, 'min_length_string'], 'returns false for a shorter string'],
...
describe.each([
    ...
    ['abc', 1, undefined, [false, 'max_length_string'], 'returns false for a longer string'],
...
describe.each([
    ...
    ['abc', 1, 2, undefined, [false, 'length_range_string'], 'returns false for a string that is too short'],
    ['a', 2, 3, 'foo {{min}} {{max}}', [false, 'foo 2 3'], 'uses correct error message'],
